...
from torchvision.models.regnet import regnet_y_8gf, RegNet_Y_8GF_Weights
...
def finetune():
    ...
    model = regnet_y_8gf(weights=weights)
    ...
    train_loop(model, optimizer, criterion, train_loader, val_loader, scheduler, "Data/Performance/RegNetY.png", 100, 5, 15, True, 'cuda')

    model_path = 'Models/FinetunedRegNetY.pth'
